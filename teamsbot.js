...
_Admin 1 : 0823-9326-7884_
_Admin 2 : 1424-379-2658_

*SCRIPT BOT 🛒*
_Rp50.000 - ( Topup & Fitur 300+ )_
_Rp100.000 - ( Topup & Fitur 600+ )_

*_Ready Nokos Whatsapp +62_*
...
const gurbot = '6282393267884@s.whatsapp.net'
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`© FAAT BOTZ 2022`
...
var raffx = '6282393267884@s.whatsapp.net'
...
axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=faatygy@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
.then(response => {     
...
const listMessage = {
  ...
  footer: '© created Faat Skizo 💀 | Faat Negro 😋',
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Faat Skizo 💀 & Faat Negro 😋' })
}
console.log(feta)
}
break
...
var opt = { packname: 'FAAT BOTZ 💀😋', author: 'Faat Skizo 💀 | Faat Negro 😋' }
